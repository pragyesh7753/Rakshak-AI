              ...
              >
                <td className="px-6 py-4 whitespace-nowrap">
                  {alert.is_read ? (
                    ...
                    <span className="px-3 py-1 text-xs font-medium text-white bg-cyan-500 rounded-full">
                      Unread
                    </span>
                  )}
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="text-sm font-medium text-white">
                    {alert.threats?.threat_type || 'Unknown'}
                  </span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="text-sm text-gray-400">
                    {alert.threats?.sector || 'N/A'}
                  </span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                    className={`px-3 py-1 text-xs font-medium text-white rounded-full ${getSeverityColor(
                      alert.threats?.severity_score || 0
                    )}`}
                  >
        ...
        {alerts.map((alert) => (
          ...
          >
            <div className="flex items-start justify-between gap-3 mb-3">
              ...
              {alert.is_read ? (
                <span className="px-3 py-1 text-xs font-medium text-gray-400 bg-gray-800 rounded-full shrink-0">
                  Read
                </span>
              ) : (
                <span className="px-3 py-1 text-xs font-medium text-white bg-cyan-500 rounded-full shrink-0">
                  Unread
                </span>
              )}
            </div>
