        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-3 sm:gap-4 mb-4">
            ...
            <div className="text-left sm:text-right">
              <div className="text-xl sm:text-2xl font-bold text-cyan-400">{threat.severity_score}</div>
          ...
          {threat.raw_posts && (
            <div className="mt-4 pt-4 border-t border-gray-800">
              <p className="text-xs text-gray-500">Source: {threat.raw_posts.author || 'Unknown'}</p>
            </div>
          )}
        </div>
      ))}
